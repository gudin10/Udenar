...
<div class="contenidoFormulario">
    ...
    <form method="post" action="principal.php?CONTENIDO=interfaces/administrador/grupoFamiliarActualizar.php&idTrabajador=<?=$trabajador->getidentificacion()?>" enctype="multipart/form-data" name="formulario">
